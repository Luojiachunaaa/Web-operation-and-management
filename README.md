...
### 2.使用标题传达页面的内容和页面的结构
![小标题](https://github.com/Luojiachunaaa/Web-operation-and-management/blob/master/images/title.png)
...
### 4.为图像编写有意义的文本替代品
网站中的每一个标题或者语言描述性文字都是具有意义的。在这个「内容为王」的地方，只有你的文案有意义，够吸引人，才会有用户愿意点击，你才会获得流量。
### 5.为多媒体制作文本和标题
![视频标题](https://github.com/Luojiachunaaa/Web-operation-and-management/blob/master/images/videoitle.png)

网站中的每个视频无论在哪个位置（首页推荐或是视频自身详情页）都有简洁清晰的标题；在视频自己的页面有up主（作者）发布时附加的相关内容简介以及与视频内容有关的tag。
### 6.提供明确指示
![登陆页面指示](https://github.com/Luojiachunaaa/Web-operation-and-management/blob/master/images/Instructions02.png)

* 在用户登陆界面，网站会提示你注册时应使用邮箱/手机号
![注册页面指示](https://github.com/Luojiachunaaa/Web-operation-and-management/blob/master/images/Instructions01.png)

* 在用户注册界面，网站会给予你一些提示*用户名的长度、密码的安全性*。
### 7.保持内容简洁明了
![页面简洁明了的小助手](https://github.com/Luojiachunaaa/Web-operation-and-management/blob/master/images/cleartitle.png)

在主页的内容和侧边栏都有简介的「使用帮助」即板块跳转链接，方便用户在冗杂的选择中快速找到自己的目标。
